---
title: "API Sandbox Request Workflow"
description: "Create collections and API requests in API Sandbox, configure URLs, headers, and request bodies, then inspect responses and generated interfaces."
alternates:
  canonical: /api-sandbox/workflow
openGraph:
  url: /api-sandbox/workflow
  type: website
...
# The API Sandbox Workflow

API Sandbox follows a simple create-and-test workflow.
