---
title: "Preview Mode: Import and Test APIs"
description: "Import Swagger, OpenAPI, or Postman collections in Preview Mode, configure API requests, inspect responses, and explore generated TypeScript interfaces."
alternates:
  canonical: /preview-mode/workflow
openGraph:
  url: /preview-mode/workflow
  type: website
...
# The Preview Mode Workflow

Preview Mode follows a simple three-step workflow.
