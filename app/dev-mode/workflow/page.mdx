---
title: "Dev Mode Workflow and Two-Way Sync"
description: "Learn how Dev Mode syncs API definitions between Reex API Builder and your local codebase, manages configuration, and helps you review API changes."
alternates:
  canonical: /dev-mode/workflow
openGraph:
  url: /dev-mode/workflow
  type: website
...
Dev Mode connects the Reex API Builder UI directly to your local codebase, creating a live link between your API specifications and your frontend logic.
...
}): Promise => apiClient.post(`/channels/${channelId}/messages`, payload);
```
